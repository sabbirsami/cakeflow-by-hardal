...
function Carousel({
  ...
  const [mountAnimationClass, setMountAnimationClass] = React.useState('opacity-0 translate-y-4');
  ...
  useEffect(() => {
    const timeoutId = window.setTimeout(() => setMountAnimationClass('opacity-100 translate-y-0'), 40);
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        orientation === 'horizontal'
          ? 'pl-2 sm:pl-3 lg:pl-4 [&[data-active="false"]]:opacity-80'
          : 'pt-4',
        mountAnimationClass,
        className,
      )}
